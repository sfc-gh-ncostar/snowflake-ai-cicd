--!jinja
USE ROLE AI_CICD_RL;
CREATE OR REPLACE CORTEX SEARCH SERVICE identifier('AI_CICD.{{ENV}}AGENTIC_AI.QUERY_HISTORY_SEARCH_SERVICE')
...
SELECT 
    ...
    BYTES_SPILLED_TO_LOCAL_STORAGE,
    BYTES_SPILLED_TO_REMOTE_STORAGE
FROM AI_CICD.AGENTIC_AI.QUERY_HISTORY_MATERIALIZED;