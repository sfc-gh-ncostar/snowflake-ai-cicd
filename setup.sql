...
WAREHOUSE = AI_CICD_WH  -- Change this to your preferred warehouse
...
SELECT SNOWFLAKE.CORTEX.SEARCH_PREVIEW(
    'AI_CICD.AGENTIC_AI.QUERY_HISTORY_SEARCH_SERVICE',
    '{
...
SHOW CORTEX SEARCH SERVICES LIKE 'AI_CICD.AGENTIC_AI.QUERY_HISTORY_SEARCH_SERVICE';
*/
...
USE ROLE AI_CICD_RL;
USE SCHEMA AI_CICD.AGENTIC_AI;
CREATE OR REPLACE AGENT AI_CICD.AGENTIC_AI.SNOWFLAKE_HOUSEKEEPING_AGENT
...
FROM SPECIFICATION $$
{
    ...
    "tool_resources": {
        "cortex_search_snowflake_query_history": {
          ...
          "max_results": 5,
          "name": "AI_CICD.AGENTIC_AI.QUERY_HISTORY_SEARCH_SERVICE"
        },
        ...
        "snowflake_account_usage": {
          "semantic_view": "AI_CICD.AGENTIC_AI.SNOWFLAKE_HOUSEKEEPING_AGENT"
        }
      }
}
$$;
...
--7. Create MCP Server
USE ROLE AI_CICD_RL;
CREATE OR REPLACE MCP SERVER AI_CICD.AGENTIC_AI.HOUSEKEEPING_MCP_SERVER FROM SPECIFICATION
$$
tools:
  ...
  - name: "Snowflake Housekeeping Cortex Analyst"
    identifier: "AI_CICD.AGENTIC_AI.MODELS/semantic_model.yaml"
